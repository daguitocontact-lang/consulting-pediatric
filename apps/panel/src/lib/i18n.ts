...
const es = {
  ...
  'patient.you': 'Paciente',
  'patient.loading': 'Abriendo la consulta…',
  'patient.retry': 'Reintentar',
  // La pantalla previa: nada arranca hasta que el papá toca el botón (ver el
  // encabezado de patient.tsx — en iOS el AudioContext lo exige, y un permiso
  // que aparece sin aviso se rechaza).
  'patient.join.for': 'Consulta de {name}',
  'patient.join.generic': 'Tu consulta está lista',
  'patient.join.point.room': 'Vas a entrar a la sala con el médico.',
  'patient.join.point.mic':
    'Tu micrófono se usa para transcribir la consulta y armar la nota clínica.',
  'patient.join.point.noEngine': 'Esta consulta no se va a transcribir; la llamada funciona igual.',
  'patient.join.point.mute': 'Puedes silenciarlo cuando quieras, sin salir de la sala.',
  'patient.join.cta': 'Entrar a la consulta',
  'patient.join.permission': 'Al entrar, el navegador te va a pedir permiso para el micrófono.',
  'patient.mic.on': 'Micrófono activo',
  'patient.mic.muted': 'Micrófono silenciado',
  'patient.mic.off': 'Sin micrófono — la consulta sigue',
  'patient.mic.starting': 'Conectando el micrófono…',
  'patient.mic.reconnecting': 'Reconectando el micrófono…',
  'patient.mic.blocked': 'Micrófono bloqueado',
  'patient.mic.deniedHint':
    'El navegador bloqueó el micrófono. Actívalo en los permisos del sitio para que la consulta quede transcrita; la llamada sigue funcionando.',
  'patient.mic.failedHint':
    'No pudimos conectar tu micrófono. La llamada sigue funcionando, pero tu parte no se va a transcribir.',
  'patient.room.failed': 'No pudimos abrir la sala de video.',
  'patient.ended.title': 'La consulta terminó',
  'patient.ended.body': 'Ya puedes cerrar esta ventana.',
...
const en: Record<Key, string> = {
  ...
  'patient.you': 'Patient',
  'patient.loading': 'Opening the consultation…',
  'patient.retry': 'Try again',
  'patient.join.for': "{name}'s consultation",
  'patient.join.generic': 'Your consultation is ready',
  'patient.join.point.room': 'You are about to join the room with the doctor.',
  'patient.join.point.mic':
    'Your microphone is used to transcribe the visit and write the clinical note.',
  'patient.join.point.noEngine': 'This visit will not be transcribed; the call works the same.',
  'patient.join.point.mute': 'You can mute it at any time without leaving the room.',
  'patient.join.cta': 'Join the consultation',
  'patient.join.permission': 'When you join, your browser will ask for microphone permission.',
  'patient.mic.on': 'Microphone on',
  'patient.mic.muted': 'Microphone muted',
  'patient.mic.off': 'No microphone — the call continues',
  'patient.mic.starting': 'Connecting your microphone…',
  'patient.mic.reconnecting': 'Reconnecting your microphone…',
  'patient.mic.blocked': 'Microphone blocked',
  'patient.mic.deniedHint':
    'Your browser blocked the microphone. Allow it in the site permissions so the visit is transcribed; the call keeps working.',
  'patient.mic.failedHint':
    'We could not connect your microphone. The call keeps working, but your side will not be transcribed.',
  'patient.room.failed': 'We could not open the video room.',
  'patient.ended.title': 'The consultation has ended',
  'patient.ended.body': 'You can close this window now.',
